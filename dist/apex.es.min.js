...
match:[/(public|private|protected)\s+/,a,s],scope:{1:"keyword",2:"constructor"},
starts:M,relevance:0},{match:[/(?<!new)(?<!return)(?<=\<|\>|\w)\s+/,a,s],scope:{
2:"title.function"},relevance:0,starts:M},{begin:[/\benum\s+/,a,/\s*(?=\{)/],
beginScope:{2:"type"},end:/(?=[\}\n])/,relevance:0,contains:[O,R,{
match:t.concat(n),scope:"variable.constant"}]}],k=[{
match:t.concat(i(...l),/\b/,a,s),scope:"title.function.invoke method_call",
starts:U,relevance:0},{match:[t.concat("(?<!\\b",t.either(...A),")"),/\./,a,s],
scope:{2:"punctuation",3:"title.function.invoke dot"},starts:U,relevance:0}],F={
