...
relevance:10}],C=[{
match:t.either(",",/;/,/(?<=\w)\>/,/\<(?=\w)/,/\{|\}/,/\(|\)/,/\{|\}/),
scope:"punctuation",relevance:0},R],I=e.inherit(e.APOS_STRING_MODE,{
...
end:"`",scope:"subst"},{begin:/'/,end:/'/,scope:"string"}]}]}),w],_={
...
1:"keyword",2:"operator"},contains:[_]},I,p],keywords:{literal:S}}],k={
...
relevance:0},Y={match:[/\bnew\s+/,a,s],scope:{2:"type"},relevance:0};let W={
...
;W.contains=[I,Y,D,_,f,O,p,U,x,{keywords:{KEYWORDS:y},
...
relevance:1,keywords:y,contains:[p,I,D,f,...O,{match:/\,|\(/,scope:"punctuation"
...
contains:[D,M,I,p,P,f,[{begin:[/\btrigger/,o,a,o,"on",o,a],beginScope:{
1:"keyword",3:"title.class",5:"operator",7:"type"},end:/(?=\{)/,returnEnd:!0,
contains:[D,{begin:/\(/,end:/\)/,contains:[{
...
relevance:0,contains:[D,R,{match:t.concat(c),scope:"variable.constant"}]},{
...
endsWithParent:!0,keywords:{literal:y.literal,built_in:g},contains:[p,_,I,R,{
match:/\(|\)/,scope:"punctuation",relevance:0},...i,{begin:[/\bFROM\b/,o],
...
},G,F,_,C,i,{match:t.concat("(?<=this.)",a,"(?!\\()"),scope:"variable"},{
match:[t.concat(/\b/,l(...L)),a,o,/(?=\{)/],scope:{2:"property"},relevance:0}]}}
