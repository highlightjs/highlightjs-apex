...
match:[t.concat(/\b/,t.either(...A)),/\./,a,/\b\s*(?![\.\(])/],scope:{
1:"built_in",2:"punctuation",3:"type"},relevance:0},{
match:[t.concat(/\b/,t.either(...h)),/\./,c,/\b(?=\.)/],scope:{1:"built_in",
2:"punctuation",3:"type"}},{
match:[t.concat(/\b/,t.either(...h,...A)),/\./,c,/\b(?!\.)/],scope:{
...
relevance:10}],C=[{
match:t.either(",",/;/,/(?<=\w)\>/,/\<(?=\w)/,/\{|\}/,/\(|\)/,/\{|\}/),
scope:"punctuation",relevance:0},R],D=e.inherit(e.APOS_STRING_MODE,{
...
match:t.either(...g),scope:"operator",relevance:0},f={match:/(?<!\.)\bId\b/,
scope:"type",relevance:8},U=[{begin:/\b(list|set|map)(?=\s*<)/,
...
match:[c,o,c,/\s*(?=\=[^\>])/],scope:{1:"type",3:"variable"},relevance:0}],P={
...
starts:W}];W.contains=[D,Y,_,w,U,N,p,f,H,{keywords:{KEYWORDS:y},
...
relevance:1,keywords:y,contains:[p,D,_,U,...N,{match:/\,|\(/,scope:"punctuation"
},f,{match:[/(?<=\(|\,)\s*/,a,/(?=\s)/],scope:{2:"type"}},{
...
contains:[_,M,D,p,P,U,[{begin:[/\btrigger/,o,a,o,"on",o,a],beginScope:{
...
relevance:0,contains:[_,R,{match:t.concat(c),scope:"variable.constant"}]},{
...
7:"operator"}},H,Y,L,N,f,{begin:[/\[/,/\s*(?=(SELECT|FIND)\b)/],end:/\]/,
beginScope:{1:"punctuation"},endScope:"punctuation",scope:"soql",relevance:10,
endsWithParent:!0,keywords:{literal:y.literal,built_in:T},contains:[p,w,D,R,{
...
},G,F,w,C,i,{match:t.concat("(?<=this.)",a,"(?!\\()"),scope:"variable"},{
