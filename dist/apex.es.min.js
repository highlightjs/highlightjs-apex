...
scope:{2:"type"},relevance:10},y=[{
match:[a,t.concat(/\s+/,a,/\b/),/(?=\s+\{\s*(public|private)?\s*(get|set)\b)/],
...
contains:[E,g,e.APOS_STRING_MODE,N,D],relevance:0,illegal:[].concat(...s)},L={
...
scope:"trigger_declaration",contains:[E,g,{begin:/\(/,beginScope:"punctuation",
...
scope:"type",relevance:8},f,i,h]}}})();export default hljsGrammar;