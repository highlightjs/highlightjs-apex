...
match:[t.concat(/\b/,t.either(...h,...v)),/\./,c,/\b(?!\.)/],scope:{
...
starts:W}];W.contains=[D,Y,_,w,U,L,p,f,H,{keywords:{KEYWORDS:y},
...
relevance:1,keywords:y,contains:[p,D,_,U,...L,{match:/\,|\(/,scope:"punctuation"
...
scope:"punctuation"},L],relevance:0}]},{begin:[/\benum\s+/,a,/\s*\{/],
...
5:"variable",7:"operator"}},H,Y,N,L,f,{begin:[/\[/,/\s*(?=(SELECT|FIND)\b)/],
...
contains:[p,w,D,R,{match:/\(|\)/,scope:"punctuation",relevance:0},...i,{
