...
2:"operator"}},"self",u]},{match:[t.concat("@",a,/\b/),/\s+(?!\()/],scope:{
1:"meta"}}],A=[{match:/\b[a-zA-Z\d]*Exception\b/,scope:"title.class",relevance:0
},{match:[/\wthrow\s+new\s+/,a],scope:{1:"keyword",2:"title.class"},relevance:0
}],h=[{match:[t.concat(/\b/,a,/\b/),">"],scope:{1:"type"},relevance:10}],S=[{
...
disableAutodetect:!1,ignoreIllegals:!1,keywords:{$pattern:a,
keyword:["trigger|10","class","interface","abstract","break","cast","catch","continue","default","do","else","exports","extends|6","finally","get","put","set","global","if","implements","new","newMap|10","old|10","oldMap|10","operationType","override","private","protected","public","return","size","static","throws","throw","testmethod|10","try","virtual","webservice","when","while"],
...
3:"keyword"}},A,_,e.APOS_STRING_MODE,v,R,i,s,o,l,O,{match:/(?<!\.)\bId\b/,
scope:"type",relevance:8},N,r,{
