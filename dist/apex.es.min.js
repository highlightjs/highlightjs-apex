...
3:"title.class"},relevance:0},B,K,{begin:[r,/@literal/],beginScope:{2:"doctag"},
end:l,returnEnd:!0,subLanguage:["apex","xml","javascript","bash"]},{
scope:"doctag",begin:"@param",end:/$/,contains:[{scope:"variable",variants:[{
match:a}],endsParent:!0}]},{variants:x,contains:[e.BACKSLASH_ESCAPE],relevance:0
},{begin:/[0-9]+\.[0-9]+/,end:/\.*\s+/,scope:"number",excludeEnd:!0},{
...
},u]}),Y,u],z={match:t.either(...I),scope:"operator",relevance:0},V=[{
