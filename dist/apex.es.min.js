...
const t=e.regex,a="[a-zA-Z][a-zA-Z_0-9]*",c="[a-zA-Z_0-9]*",n="\\b"+a+"\\b",s="@"+a,o=/(?=\s*\()/,i=/\s+/,r=/\{/,l=/\s*\}/,p=/\(/,b=/\)/,u={
...
$pattern:t.concat(/(?<!\.)\b/,a,/\b/),keyword:[...A,...T,...L],type:y,literal:C
},U=[...C,...A,...T,...O,...N,...w,...R,...L],k={
...
match:[t.concat(/\b/,t.either(...O)),/\./,n,/\b(?=\.)/],scope:{1:"built_in",
...
match:[/(?<!\{\s*)@see\s+/,t.concat(n,/(?=\s)/)],scope:{1:"doctag",
...
begin:[/\{*/,H,c,t.concat(G,a),/\s*\(/],beginScope:{2:"doctag",3:"title.class",
...
match:[/\{*/,H,t.concat(c,G,a),/(?=[\}\s])/],scope:{2:"doctag",
3:"title.function"}},{match:[r,H,a,l],scope:{2:"doctag",3:"title.class"}},{
begin:[r,H,/(?=")/],beginScope:{2:"doctag"},end:l,contains:x},{begin:[r,H],
beginScope:{2:"doctag"},end:l,returnEnd:!0,subLanguage:["markdown","xml"],
contains:[{match:d,scope:"link"}]}],Q=[e.COMMENT("/\\*","\\*/",{relevance:0,
contains:[{begin:/\w+@/,relevance:0},{
match:[/@(?:exception|throws)/,i,t.concat(a,m,a)],scope:{1:"doctag",
3:"title.class"},relevance:0},{match:[/@(?:exception|throws)/,i,a],scope:{
1:"doctag",3:"title.class"},relevance:0},B,K,{begin:[r,/@literal/],beginScope:{
2:"doctag"},end:l,returnEnd:!0,subLanguage:["apex","xml","javascript","bash"]},{
match:[/(?<=@param)\s+/,a],scope:{2:"variable"},relevance:0},{variants:x,
contains:[e.BACKSLASH_ESCAPE],relevance:0},{begin:/[0-9]+\.[0-9]+/,end:/\.*\s+/,
scope:"number",excludeEnd:!0},{
...
match:s,scope:"doctag",relevance:0}]}),Y],z={match:t.either(...I),
scope:"operator",relevance:0},V=[{begin:/\b(list|set|map)(?=\s*<)/,
...
2:"punctuation"},relevance:0}],Z=[{match:t.concat(s,/\b(?!\s*\()/),scope:"meta"
},{scope:"meta",begin:[t.concat(s,/\b/),/\s*/,p],beginScope:{3:"punctuation"},
end:b,endScope:"punctuation",contains:[{match:[n,/\s*=/],scope:{1:"keyword",
...
match:[/\bnew\s+/,a,o],scope:{2:"type"},relevance:0};let J={begin:p,
beginScope:"punctuation",end:b,endScope:"punctuation",relevance:0,keywords:f,
contains:[]};const ee=[{match:[/(?<=\.)/,a,o],scope:{2:"title.function.invoke1"
...
contains:[Q,D,{match:t.concat(n),scope:"variable.constant"}]},{
...
contains:[S,z,P,D,{match:/\(|\)/,scope:"punctuation",relevance:0},...g,{
