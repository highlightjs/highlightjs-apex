...
begin:[/\{*/,H,c,t.concat(B,a),/\s*\(/],beginScope:{2:"doctag",3:"title.class",
...
match:[/\{*/,H,t.concat(c,B,a),/(?=[\}\s])/],scope:{2:"doctag",
...
1:"doctag",3:"title.class"},relevance:0},G,K,{begin:[r,/@literal/],beginScope:{
