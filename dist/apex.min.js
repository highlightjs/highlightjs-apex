...
const t=e.regex,a="[a-zA-Z][a-zA-Z_0-9]*",c="\\b"+a+"\\b",n="@"+a,s=/(?=\s*\()/,o=/\s+/,i=/\?\./,r=[{
...
2:"title.function.invoke"},relevance:1,contains:[...r],starts:W},{
...
relevance:0,contains:[_,g,{match:t.concat(c),scope:"variable.constant"}]},{
...
7:"operator"}},H,Y,O,N,U,{begin:[/\[/,/\s*(?=(SELECT|FIND)\b)/],end:/\]/,
beginScope:{1:"punctuation"},endScope:"punctuation",scope:"soql",relevance:10,
endsWithParent:!0,keywords:{literal:y.literal,built_in:T},contains:[p,w,D,g,{
match:/\(|\)/,scope:"punctuation",relevance:0},...r,{begin:[/\bFROM\b/,o],
...
},B,F,w,C,r,{match:t.concat("(?<=this.)",a,"(?!\\()"),scope:"variable"},{
