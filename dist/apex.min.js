...
scope:{1:"type",2:"punctuation"},contains:[S],relevance:0}],_={
scope:"assignment",relevance:0,contains:[S,A],variants:[{
...
contains:[c,e.APOS_STRING_MODE,h,g,A,_,v,d,m,c,"self",{
...
contains:[O,h,S],illegal:":",relevance:0}],D={end:/(?=\)\s*[^{])/,returnEnd:!0,
...
contains:[h,g,e.APOS_STRING_MODE,O,N,"self"],relevance:0,illegal:[].concat(...s)
},I={begin:[/\btrigger/,/\s+/,a,/\s+/,"on",/\s+/,a],beginScope:{1:"keyword",
3:"title.class",5:"operator",7:"type"},end:"{",returnEnd:!0,
scope:"trigger_declaration",contains:[h,g,{begin:/\(/,beginScope:"punctuation",
...
end:/[\}\n]/,returnEnd:!0,scope:"enum_declaration",relevance:0,contains:[h,g,S,{
...
2:"constructor"},end:/\{/,contains:[O,S]}],y),M=[{
...
contains:[T,_,v,g,h,C,w,R,f,e.APOS_STRING_MODE,N,D,m,c,A,S,M,{
