...
}),g=[{match:t.concat(c,/\b(?!\s*\()/),scope:"meta SOLO"},{
begin:[t.concat(c,/\b/),/\s*\(/],beginScope:{1:"meta annotations",
2:"punctuation"},end:/\)/,endScope:"punctuation end",scope:"annotation",
contains:[{match:[/\b/,a,/\s*=/],scope:{2:"meta keyword",3:"operator"}
},e.APOS_STRING_MODE,n],keywords:{literal:o}}],T=[{
...
match:[a,/\s+/,a,/\s+/,/(?==)/],scope:{1:"type",3:"variable"},relevance:0},{
match:[a,/\s+/,a,/\s+/,";"],scope:{1:"type",3:"variable"},relevance:0},{
match:[/\s+/,a,/\s+/,/(?==)/],scope:{2:"variable"},relevance:0},{
...
contains:[O,A,S],illegal:":"}],y={end:/(?=\)\s*[^{])/,returnEnd:!0,
scope:"method call",variants:[{begin:t.concat(a,/(?=\s*\()/),
beginScope:"title.function.invoke"},{begin:[a,/\./,t.concat(a,/(?=\s*\()/)],
beginScope:{1:"class.title",3:"title.function.invoke"}}],
contains:[A,E,e.APOS_STRING_MODE,O,N],relevance:0,illegal:[].concat(...s)},D={
...
3:"keyword"}}],T,w,e.APOS_STRING_MODE,N,y,d,n,h,S,M,{match:/(?<!\.)\bId\b/,
